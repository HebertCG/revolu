...
// Inspired by ui.aceternity.com/components/lamp-effect
...
export function Lamp({
  ...
  return (
    <div
      className={cn(
        "relative z-0 flex min-h-[40rem] flex-col items-center justify-center overflow-hidden rounded-md bg-background w-full",
        className,
      )}
    >
      <div className="relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 w-[30rem] overflow-visible bg-gradient-conic from-amber-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <div className="absolute top-1/2 z-50 h-48 w-full translate-y-12 scale-x-150 bg-background blur-2xl" />
