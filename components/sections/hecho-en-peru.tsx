    ...
    <section className="relative overflow-hidden py-20 sm:py-28">
      <Container>
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            <span className="inline-flex items-center gap-2 rounded-full border border-amber-400/30 bg-amber-400/5 px-3 py-1 text-xs font-medium uppercase tracking-wider text-amber-700 dark:text-amber-300">
            ...
            <h2 className="mt-4 text-balance text-4xl font-semibold tracking-tight sm:text-5xl">
              ...
              <span className="gradient-text-gold">
                Preparado para todo el norte del Perú.
              </span>
            </h2>
            <p className="mt-4 text-base leading-relaxed text-muted-foreground sm:text-lg">
              REVOLU nace del norte porque ahí es donde más academias preuniversitarias compiten
              por preparar alumnos para UDEP y UPAO. Las distancias, los cortes de luz, el internet
              variable: todo está pensado para tu realidad — no para una oficina en San Isidro.
            </p>
                ...
                >
                  <MapPin
                    className={`h-3.5 w-3.5 ${
                      c.primary ? "text-amber-500" : "text-muted-foreground"
                    }`}
                  />
          ...
          <div className="relative mx-auto aspect-[4/5] w-full max-w-md">
            <div
              aria-hidden
              className="absolute inset-0 -z-10 bg-gradient-radial from-amber-400/10 via-transparent to-transparent blur-2xl"
            />
            ...
            >
              ...
              {cities.map((c, i) => (
                <g key={c.name}>
                  ...
                  <motion.circle
                    ...
                    cy={c.y}
                    r={c.primary ? 1.4 : 0.9}
                    fill={c.primary ? "#f59e0b" : "rgb(var(--foreground))"}
                    initial={{ opacity: 0, scale: 0 }}
                    whileInView={{ opacity: 1, scale: 1 }}
                    viewport={{ once: true }}
              ...
              <g transform="translate(85, 12)">
                ...
                <text x="0" y="-2.2" fontSize="2.4" textAnchor="middle" className="fill-amber-500 font-semibold">
                  N
                </text>
