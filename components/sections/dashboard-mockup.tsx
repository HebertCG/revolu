...
export function DashboardMockup() {
  return (
    <div className="relative rounded-2xl border border-border/60 bg-card/80 p-2 shadow-2xl backdrop-blur-md">
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 rounded-2xl ring-1 ring-inset ring-amber-400/10"
      />
      <div className="overflow-hidden rounded-xl border border-border bg-background">
        ...
        <div className="flex items-center gap-2 border-b border-border bg-muted/40 px-4 py-2.5">
          ...
          <div className="ml-3 flex items-center gap-1.5 rounded-md border border-border bg-background px-2.5 py-1 text-[10px] text-muted-foreground">
            ...
            intranet.andinos-piura.pe
          </div>
        </div>

        <div className="grid grid-cols-12 gap-0">
          {/* Sidebar — always dark inside the mockup */}
          <aside className="hidden col-span-3 flex-col bg-zinc-950 p-3 text-zinc-200 md:flex md:min-h-[460px]">
            <div className="mb-4 flex items-center gap-2 px-2">
              <span className="grid h-7 w-7 place-items-center rounded-md bg-gradient-to-br from-amber-300 to-amber-600 text-xs font-bold text-amber-950">
                R
              </span>
              <div className="leading-tight">
                <p className="text-[10px] font-semibold tracking-wide gradient-text-gold">
                  Andinos
                </p>
            ...
            {/* User card */}
            <div className="mb-4 rounded-lg border border-zinc-800 bg-zinc-900 p-2">
              <div className="flex items-center gap-2">
                <div className="grid h-7 w-7 place-items-center rounded-full bg-gradient-to-br from-amber-300 to-amber-600 text-[9px] font-bold text-amber-950">
                  AN
                </div>
                <div className="min-w-0">
                  <p className="truncate text-[10px] font-medium text-zinc-100">
                    Abarca Navarro
                  </p>
                  <p className="flex items-center gap-1 text-[8px] text-amber-400">
              ...
              {sidebarItems.map(({ icon: Icon, label, active }) => (
                <li key={label}>
                  <div
                    className={
                      active
                        ? "flex items-center justify-between gap-2 rounded-md bg-amber-400/15 px-2 py-1.5 text-[10px] font-medium text-amber-300 ring-1 ring-amber-400/20"
                        : "flex items-center gap-2 rounded-md px-2 py-1.5 text-[10px] text-zinc-400 hover:text-zinc-200"
                    }
                  >
            ...
            <div className="mt-auto pt-3">
              <div className="flex items-center gap-2 rounded-md px-2 py-1.5 text-[10px] text-zinc-400">
          ...
          <main className="col-span-12 bg-[rgb(var(--background))] p-4 md:col-span-9 md:p-5">
            ...
            <div className="grid gap-3 md:grid-cols-3">
              <div className="rounded-xl border border-amber-400/15 bg-gradient-to-br from-amber-50/80 to-yellow-50/40 p-4 dark:from-amber-400/[0.04] dark:to-yellow-400/[0.02] md:col-span-2">
                <p className="inline-flex items-center gap-1.5 text-[10px] font-medium uppercase tracking-wider text-amber-600 dark:text-amber-400">
                  Buenos días <span aria-hidden>👋</span>
                </p>
                <h3 className="mt-1 text-xl font-semibold tracking-tight text-foreground">
                  Hola, <span className="text-amber-600 dark:text-amber-400">Abarca</span>
                </h3>
                ...
                <div className="mt-4 grid grid-cols-3 gap-2">
                  <StatPill label="Cursos" value="4" tone="amber" icon={BookOpen} />
                  <StatPill label="Hoy" value="0" tone="cream" icon={Calendar} />
              ...
              <motion.div
                ...
                className="relative overflow-hidden rounded-xl bg-gradient-to-br from-amber-500 via-amber-500 to-amber-600 p-4 text-amber-50 shadow-[0_8px_30px_-12px_rgb(245_158_11/0.6)]"
              >
                <div
                  aria-hidden
                  className="absolute -right-6 -top-6 h-20 w-20 rounded-full bg-yellow-300/30 blur-2xl"
                />
                <p className="inline-flex items-center gap-1.5 text-[9px] font-medium uppercase tracking-wider text-amber-100">
                ...
                <p className="mt-1 text-[10px] leading-snug text-amber-50/80">
                  Aprovecha para repasar materiales.
                </p>
                <button
                  type="button"
                  className="mt-3 inline-flex items-center gap-1 rounded-md bg-amber-950/30 px-2.5 py-1 text-[10px] font-medium text-amber-50 ring-1 ring-amber-100/20 transition-colors hover:bg-amber-950/40"
                >
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-start justify-between gap-1">
                        <div
                          className={`grid h-7 w-7 place-items-center rounded-md bg-gradient-to-br ${c.accent} text-amber-950`}
                        >
                          <Icon className="h-3 w-3" />
                        </div>
                        <span className="rounded-full bg-amber-400/15 px-1.5 py-0.5 text-[7px] font-semibold uppercase tracking-wider text-amber-700 dark:text-amber-300">
                          UDEP
                        </span>
                      </div>
                      ...
                      <div className="mt-2 flex items-center justify-between border-t border-border pt-1.5">
                        <div className="flex items-center gap-1">
                          <span className="grid h-3.5 w-3.5 place-items-center rounded-full bg-amber-400/20 text-[6px] font-semibold text-amber-700 dark:text-amber-300">
                            {c.initials}
                          </span>
            ...
            <div className="mt-3 grid grid-cols-1 gap-3 md:grid-cols-2">
              ...
              <div className="rounded-lg border border-border bg-card p-3">
                <div className="mb-2 flex items-center justify-between">
                  ...
                  <span className="rounded-full bg-amber-400/15 px-1.5 py-0.5 text-[8px] font-semibold tabular-nums text-amber-700 dark:text-amber-300">
                    1
                  </span>
                </div>
                <div className="flex items-center gap-3 rounded-md border border-amber-400/30 bg-amber-400/5 px-3 py-2.5">
                  <div className="flex flex-col items-center justify-center border-r border-amber-400/20 pr-3">
              ...
              <div className="rounded-lg border border-border bg-card p-3">
                <div className="mb-2 flex items-center justify-between">
                  <p className="inline-flex items-center gap-1 text-[10px] font-semibold tracking-tight">
                    <PieChart className="h-2.5 w-2.5 text-amber-500" />
                    Asistencia global
                  </p>
                ...
                <div className="flex items-center gap-3">
                  <div>
                    <span className="text-2xl font-semibold tabular-nums gradient-text-gold">
                      100%
                    </span>
...
function StatPill({
  ...
  const styles = {
    amber: "from-amber-100/90 to-amber-50/60 dark:from-amber-400/[0.08] dark:to-amber-400/[0.02] border-amber-300/40 dark:border-amber-400/15",
    cream: "from-yellow-100/90 to-amber-50/60 dark:from-yellow-400/[0.06] dark:to-yellow-400/[0.02] border-yellow-300/40 dark:border-yellow-400/15",
