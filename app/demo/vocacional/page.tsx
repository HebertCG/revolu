...
export default function DemoVocacional() {
  return (
    <div className="mx-auto max-w-7xl">
      {/* Hero card */}
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-amber-500 via-amber-500 to-amber-600 p-8 text-amber-50 shadow-[0_24px_60px_-20px_rgb(245_158_11/0.5)] sm:p-12">
        <div
          aria-hidden
          className="absolute -right-16 -top-16 h-72 w-72 rounded-full bg-yellow-300/30 blur-3xl"
        />
        <div
          aria-hidden
          className="absolute inset-0 bg-grid-small opacity-15"
        />
        <span className="relative inline-flex items-center gap-1.5 rounded-full bg-amber-950/30 px-3 py-1 text-[11px] font-bold uppercase tracking-wider text-amber-50 ring-1 ring-amber-100/20">
        ...
        <h1 className="relative mt-5 text-balance text-4xl font-semibold leading-[1.05] tracking-tight text-white sm:text-5xl md:text-6xl">
          Descubre tu
          <br />
          <span className="bg-gradient-to-r from-amber-50 via-yellow-100 to-amber-100 bg-clip-text text-transparent">
            carrera ideal
          </span>
        </h1>
        <p className="relative mt-5 max-w-2xl text-base leading-relaxed text-amber-50/80 sm:text-lg">
      ...
      {demoVocational.practiceMode && (
        <div className="mt-5 flex items-start gap-3 rounded-2xl border border-amber-300/50 bg-amber-50 px-4 py-3 dark:border-amber-400/20 dark:bg-amber-400/[0.06]">
      ...
      <section className="mt-6 grid gap-5 lg:grid-cols-3">
        <div className="rounded-3xl border border-border bg-card p-6 sm:p-8 lg:col-span-2">
          <div className="flex items-start gap-4">
            <span className="grid h-12 w-12 place-items-center rounded-2xl bg-gradient-to-br from-amber-300 to-amber-600 text-amber-950 shadow-[0_8px_24px_-8px_rgb(245_158_11/0.5)]">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3 border-t border-border pt-5">
            <button
              type="button"
              className="group inline-flex h-12 items-center gap-2 rounded-full bg-gradient-to-b from-amber-400 to-amber-500 px-6 text-sm font-semibold text-amber-950 shadow-[0_8px_24px_-8px_rgb(245_158_11/0.5)] transition-transform hover:scale-[1.02]"
            >
              Comenzar test
      ...
      <section className="mt-10 rounded-3xl border border-zinc-800 bg-zinc-950 p-6 text-zinc-100 sm:p-10">
        <p className="inline-flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-amber-400">
          <Sparkles className="h-3 w-3" />
          ¿Cómo funciona?
        </p>
...
function Pill({
  ...
  return (
    <span className="inline-flex items-center gap-1.5 rounded-full bg-amber-950/25 px-3 py-1.5 text-xs font-semibold text-amber-50 ring-1 ring-amber-100/20 backdrop-blur">
  ...
  return (
    <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-6">
      <div className="flex items-start justify-between gap-2">
        <span className="grid h-10 w-10 place-items-center rounded-xl bg-zinc-800 text-amber-400">
